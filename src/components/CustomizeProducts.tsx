  ...
  return (
    <div className='flex flex-col gap-6'>
      ...
      <ul className='flex items-center gap-3'>
        <li className='ring-1 ring-ozia text-ozia rounded-md py-1 px-4 text-sm cursor-pointer'>Small</li>
        <li className='ring-1 ring-ozia text-white bg-ozia rounded-md py-1 px-4 text-sm cursor-pointer'>Medium</li>
        <li className='ring-1 ring-ozia text-ozia bg-green-100 rounded-md py-1 px-4 text-sm cursor-not-allowed'>Large</li>
      </ul>
    </div>
  )
}
